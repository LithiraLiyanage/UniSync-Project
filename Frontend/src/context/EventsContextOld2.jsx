...
export const EventsProvider = ({ children }) => {
  ...
  // Custom event emitter for cross-tab communication
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (savedEvents) {
      try {
        ...
        console.log('Loading events from localStorage:', parsedEvents);
  ...
  const addEvent = (newEvent) => {
    ...
    setEvents(prevEvents => {
      ...
      console.log('New events array after add:', updatedEvents);
  ...
  const updateEvent = (id, updatedEvent) => {
    ...
    setEvents(prevEvents => {
      ...
      console.log('New events array after update:', updatedEvents);
      return updatedEvents;
    });
  };
  ...
  const deleteEvent = (id) => {
    ...
    setEvents(prevEvents => {
      ...
      console.log('New events array after delete:', updatedEvents);
      return updatedEvents;
    });
  };
