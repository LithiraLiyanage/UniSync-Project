...
import { FiUsers, FiCalendar, FiMapPin, FiClock, FiCheck, FiX, FiInfo, FiFilter, FiSearch, FiEdit2, FiTrash2, FiPlus, FiEye, FiDownload, FiBarChart2, FiSettings, FiGrid, FiStar, FiImage } from 'react-icons/fi';
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center space-x-4">
                        ...
                        <label
                          ...
                          className="px-4 py-2 bg-purple-500 text-white rounded-lg hover:bg-purple-600 transition-colors cursor-pointer font-medium"
                        >
...
export default AdminSocialEventsFinal;
